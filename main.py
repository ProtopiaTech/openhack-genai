...
def get_file_classification(credential, temp_pdf_path):
    ...
    Użyj następujących etykiet: personal_data dla "Dane osobowe", private dla "Prywatny", oraz public dla "Publiczny"
...
def add_document_to_vector_store(vector_store, file_path,data_classification):
...
if __name__ == "__main__":
    ...
    vector_store = get_vector_store(credential, "test110")
