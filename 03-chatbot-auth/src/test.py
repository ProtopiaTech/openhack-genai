...
if __name__ == "__main__":
    ...
    retriever = vector_store.as_retriever(
        search_type="hybrid",
        search_kwargs={
            "filters": "data_classification eq 'personal-data'"
            }
    )
    query = "Procedura reklamacji"
    results = retriever.get_relevant_documents(query)#, filters="data_classification eq 'public'")
